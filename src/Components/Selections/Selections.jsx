        ...
        <div className="sticky top-0 bg-theme-secondary z-30">
            <div className="max-w-7xl mx-auto md:h-[120px] h-auto pb-2 px-4">
                ...
                <div className="flex flex-wrap gap-2 items-center">
                    <p className={place ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{place || 'Destination'} {place ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setPlace("")} /> : undefined} </p>
                    <p className={days ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{days || 'Days'} {days ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setDays("")} /> : undefined} </p>
                    <p className={members ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{members || 'Members'} {members ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setMembers("")} /> : undefined} </p>
                    <p className={budget ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{budget || "Budget"} {budget ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setBudget("")} /> : undefined} </p>
                    <p className={accommodation ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{accommodation || 'Accommodation'} {accommodation ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setAccommodation("")} /> : undefined} </p>
                    <p className={transportation ? `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-blue-600 text-white rounded-md md:my-2 mx-1 w-fit font-semibold` : `flex justify-start items-center gap-2 text-xs md:text-sm border-2 px-2 py-1 bg-theme-fifth font-bold rounded-md md:my-2 mx-1 w-fit font-semibold`}>{transportation || 'Transportation'} {transportation ? <RxCrossCircled className="tex-xl cursor-pointer" onClick={() => setTransportation("")} /> : undefined} </p>
