...
const TravelPurpose = ({value , setValue , travelPurposeScroll , scrollHandler}) => {
    return (
        <div ref={travelPurposeScroll} className="max-w-7xl mx-auto px-2 md:px-16 py-8">
            <div>
                <h2 className='text-2xl font-bold text-center'>What is the main focus of your trip?</h2>
            </div>
            <div className="flex justify-center items-center gap-6 py-4">
                <div onClick={() => { setValue("Leisure/Vacation"); scrollHandler() }} className={value === "Leisure/Vacation" ? `card shadow-xl border duration-150 border-[#00B277] bg-[#00b2771f]` : `card shadow-xl border duration-150 hover:border hover:-mt-4 hover:border-[#00B277] hover:bg-[#00b2771f]`}>
