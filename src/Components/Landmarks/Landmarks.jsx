...
const Landmarks = ({value , setValue , scrollHandler , landmarksScroll}) => {
    return (
        <div ref={landmarksScroll} className="max-w-7xl mx-auto px-2 md:px-16 py-8">
            <div>
                <h2 className='text-2xl font-bold text-center'> Any must-visit places? </h2>
            </div>
            <div className="flex justify-center items-center gap-6 py-4">
                <div onClick={() => { setValue("Historical Sites/Cultural Landmarks"); scrollHandler(accommodationScroll) }} className={value === "Historical Sites/Cultural Landmarks" ? `card shadow-xl border duration-150 border-[#00B277] bg-[#00b2771f] h-[360px]` : `card shadow-xl border duration-150 hover:border hover:-mt-4 hover:border-[#00B277] hover:bg-[#00b2771f] h-[360px]`}>
