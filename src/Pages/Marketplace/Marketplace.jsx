...
const TRIP_CARDS = [
  ...
  },
  {
    ...
    "price": "$1200",
    "rating": 5,
    "keypoints": ["LUXURY STAY", "PRIVATE BEACH", "ALL-INCLUSIVE"]
  },
  {
  ...
  },
  {
    ...
    "price": "$1500",
    "rating": 5,
    "keypoints": ["ROMANTIC ESCAPE", "SEA VIEW", "INFINITY POOL"]
  },
  {
  ...
  },
  {
    ...
    "price": "$900",
    "rating": 4,
    "keypoints": ["WILDLIFE SAFARI", "LUXURY CAMPING", "NIGHT DRIVES"]
  },
  {
        ...
        <Box className="space-y-4">
            ...
            <Box className="w-full max-w-screen-xl m-auto space-y-6">
                ...
                <Box className="w-full gap-8 grid grid-cols-4 max-xl:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 max-sm:p-2">
                    {
                        TRIP_CARDS.map((tripCard, index) => <TripCard key={index} {...tripCard}/>)
                    }
                </Box>
            </Box>
        </Box>
