    ...
    <Box className="max-w-screen-xl m-auto space-y-4">
        ...
        <Box className="w-full flex flex-row items-center justify-center max-sm:flex-wrap space-x-1">
            <Flex className="flex flex-col items-center justify-center w-[430px] max-sm:w-full space-y-1">
                <Link to={'/marketplace?keypoints=LUXURY+STAY'} target="_blank" referrerPolicy="no-referrer" className="w-full relative overflow-hidden">
                    <Image
                    ...
                    />
                    <Box className="absolute bottom-0 text-white bg-black/40 w-full rounded-xl">
                        <Text className="text-center text-lg font-bold max-lg:text-xs max-sm:text-base">Luxury Retreat</Text>
                    </Box>
                </Link>
                <HStack>
                    <Link to={'/marketplace?keypoints=SHARED+TRANSFER'} target="_blank" referrerPolicy="no-referrer" className="w-full relative overflow-hidden">
                        <Image
                    ...
                    <Link to={'/marketplace'} target="_blank" referrerPolicy="no-referrer" className="w-full relative overflow-hidden">
                        <Image
            ...
            <Link to={"/marketplace"} target="_blank" referrerPolicy="no-referrer" className="w-[640px] relative">
                <Image
                    ...
                    className="object-cover w-full h-full max-sm:h-96 rounded-xl"
                />
                <Box className="absolute bottom-1 text-white bg-black/40 w-full rounded-xl">
            ...
            <Box className="flex flex-col items-center justify-center w-[335px] max-sm:w-full space-y-1">
                <Link to={"/marketplace"} target="_blank" referrerPolicy="no-referrer" className="relative max-sm:w-full overflow-hidden">
                    <Image
